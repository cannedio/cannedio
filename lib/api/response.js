...
class Response extends ApiBase {
   ...
   * @returns {Promise}
   * @example
   * CannedIO.api.response.get(responseId)
   ...
   * );
   * 
   * CannedIO.api.response.create(responseData)
   ...
   * 
   * CannedIO.api.response.update(existingResponse)
   ...
   * @returns {Promise}
   * @example
   * CannedIO.api.response.remove(responseId)
   * .then(resp => console.log('success:', resp.toJSON()))
   * .catch(error => console.log('something is wrong:', error));
   */
  remove(responseId) {
